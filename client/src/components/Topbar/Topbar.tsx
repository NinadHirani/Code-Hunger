				...
				<div className='flex items-center space-x-4 flex-1 justify-end'>
					...
					{user && (
						<div className='cursor-pointer group relative'>
							<div className='w-8 h-8 bg-dark-fill-3 rounded-full flex items-center justify-center text-white font-medium'>
					...
					{user && (
						<button
							...
							className='bg-dark-fill-3 py-1 px-2 cursor-pointer rounded hover:bg-dark-fill-2'
						>
							Logout
						</button>
					)}
